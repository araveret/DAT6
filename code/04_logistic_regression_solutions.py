...
# d.student = (d.student == 'Yes').astype(int) # Alternatively
...
Example: In our dataset, β1 = 0.0042979750671040349 ~= 0.0043
...
plt.plot([1700, 2500], pred_prob[:,1], 'ko')
