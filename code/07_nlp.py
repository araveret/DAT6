...
for entity in extract_entities('Josiah and Sinan are instructors for General Assembly in Washington, D.C.'):
...
# Sample sentences
sentences = ['I love Josiah!', 'I hate Josiah!', 'I feel nothing about Josiah!']
